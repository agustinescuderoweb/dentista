...
function contactos() {
  return (
    <div id="contactos" className='md:flex md:flex-row md:justify-center lg:w-full lg:h-[250px] flex flex-col justify-center items-center bg-white lg:justify-center lg:flex lg:flex-row lg:gap-32 '>
        ...
        <h2 className='md:flex md:flex-row md:justify-center md:gap-3 md:items-center lg:flex lg:flex-row lg:justify-center lg:items-center flex flex-row justify-center items-center text-center'>Instagram<Image src={Instagram} alt='instagram' className='md:w-[30px]' width={50}></Image></h2>
