...
function soluciones() {
  return (
    ...
    <div className='flex flex-row w-100% h-[300px] bg-white justify-center items-center gap-4 mt-12'>
    ...
    <div className='flex flex-row bg-white justify-center aling-center gap-[100px] mb-[200px]'>
      <div className="shadow-lg shadow-blue-500/50 p-1 bg-white rounded-lg"><Image src={odontologa} width={450}></Image></div>
      <div className='w-[600px] flex flex-col gap-6 mt-7'>
