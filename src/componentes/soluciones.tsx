  ...
  return (
    ...
    <div className='flex flex-row w-100% h-[300px] bg-white justify-center items-center mt-22'>
      <div className='w-[250px] flex flex-col items-center'>
        <Image src={dentista} className='w-[50px]' width={100}></Image>
        <h2>Ortodoncia</h2>
      </div>
      <div className='w-[250px] flex flex-col items-center'>
        <Image src={dental} className='w-[50px]' width={100}></Image>
        <h2>Implantes</h2>
      </div>
      <div className='w-[250px] flex flex-col items-center'>
        <Image src={analisis} className='w-[50px]' width={100}></Image>
        <h2>Blancamientos</h2>
      </div>
      <div className='w-[250px] flex flex-col items-center'>
        <Image src={implantes} className='w-[50px]' width={100}></Image>
        <h2>Implantes</h2>
      </div>
      <div className='w-[250px] flex flex-col items-center'>
        <Image src={extracciones} className='w-[50px]' width={100}></Image>
        <h2>Extracciones</h2>
      </div>
    </div>
    <div  id="servicios"  className='md:flex md:flex-row md:justify-center md:items-center md:mt-0 md:gap-6 md:mb-0 flex flex-col bg-white w-[100%] justify-center items-center text-center gap-[100px] pb-[200px] mt-12'>
      <div className="md:mt-12 md:ml-16"><Image src={odontologa} className='md:w-[300px] w-[450px] lg:w-[500px] rounded-lg shadow-lg hover:shadow-2xl lg:rounded-lg lg:shadow-lg lg:hover:shadow-2xl'></Image></div>
