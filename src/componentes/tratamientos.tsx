...
function tratamientos() {
  return (
    <div className='md:gap-6 md:h-full lg:flex lg:flex-row lg:h-full lg:gap-[150px] lg:mt-0 bg-white flex flex-col gap-[90px] justify-center items-center pb-16 mt-16'>
